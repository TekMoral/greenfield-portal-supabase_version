...
const SubjectForm = ({ subject = null, onSuccess, onCancel }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      showToast(
        `Failed to ${subject ? "update" : "create"} subject: ${errorMessage}`,
        "error"
      );
    } finally {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            {...register("code", {
              ...
              pattern: {
                value: /^[A-Z0-9_]+$/,
                message:
                  "Subject code must contain only uppercase letters, numbers, and underscores",
              },
              maxLength: {
                value: 10,
          ...
          <p className="mt-1 text-xs text-gray-500">
            Auto-generated from name and department. You can modify it if
            needed.
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Core subjects are mandatory for all students regardless of their
                class category
              </p>
            </div>
            <div className="flex items-center">
              ...
              <label className="ml-2 text-sm font-medium text-gray-700">
                {watchIsCore
                  ? "Yes, this is a core subject"
                  : "No, this is not a core subject"}
              </label>
            </div>
          </div>
            ...
            <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-center">
                ...
                <p className="text-sm text-blue-800">
                  This subject will be available to all students regardless of
                  their class category (Science, Arts, Commercial).
                </p>
              </div>
            </div>
          )}
